...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "XF86MonBrightnessUp",
        function ()
            os.execute("/home/maben/.config/awesome/change_brightness.py up")
        end),

    awful.key({ }, "XF86MonBrightnessDown",
        function ()
            os.execute("/home/maben/.config/awesome/change_brightness.py down")
        end)
